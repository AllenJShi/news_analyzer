...
def get_default_sources():
    ...
    return [
        ...
        {"url": "https://sspai.com/feed", "name": "少数派", "category": "科技新闻"},
        # 商业与金融
        {
        ...
        {"url": "https://thehill.com/feed", "name": "The Hill", "category": "政治新闻"},
        {
        ...
        {"url": "https://variety.com/feed/", "name": "Variety", "category": "娱乐新闻"},
        {
        ...
        {"url": "https://www.tmz.com/rss.xml", "name": "TMZ", "category": "娱乐新闻"},
        # 健康与医疗
        {
    ...
    for source in sources:
        try:
            rss_collector.add_source(
                url=source["url"], name=source["name"], category=source["category"]
            )
            count += 1
